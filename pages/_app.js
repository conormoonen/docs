...
const TITLE = 'StationOps';
const DESCRIPTION = 'StationOps DOCS';
...
export default function MyApp(props) {
  ...
  const isLandingPage = false && props.router.pathname === '/';
  ...
  return (
    <div className={`${isLandingPage ? 'page--landing' : ''}`}>
      <Head>
        ...
        <script async defer src="addhotjar.js"></script>
      ...
      <TopNav>
        <Link href="https://twitter.com/stationops">Twitter</Link>
        <span className="primary no-mobile">
          <Link href={APP_HOST}>Try</Link>
        </span>
      </TopNav>
      <div className="page">
        {isDocs ? <SideNav /> : null}
        <main className="flex column">
          ...
          {(props.router.asPath ==='/' || props.router.asPath.startsWith('/index')) &&
              <GettingStarted />
          }
